...
2.Cuando estes en Github, haz click en el boton "code", luego en "create a codespace on master", seguido de esto, realiza un cambio en el archivo "README.es.md", guarda los cambios
