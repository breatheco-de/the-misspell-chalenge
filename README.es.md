...
2.1. Haz clic en el botón "contribuir" al lado derecho de las instrucciones del proyecto.  
2.2. Haz clic en el archivo fuente del proyecto README.md y luego en el icono del lápiz para editar el archivo.  
2.3. Arregla el error ortográfico del proyecto (o contribuye con nuevas aportaciones).  
