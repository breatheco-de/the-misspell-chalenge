...
Learning in public means colaboration, and you don't have to be an expert to colaborate. Misspells come to the rescue! The perfect ice-breaker for open-source contributions. Fixing a misspell is easy and requires almost no GitHub or Git experience.
...
1. Find one misspell on any of the 4Geeks lessons, projects or exercises and create a `pull request` with the fixing.
