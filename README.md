...
Learning in public means collaboration, and you don't have to be an expert to collaborate. Misspelling come to the rescue! The perfect ice-breaker for open-source contributions; fixing a misspelling is easy and requires almost no GitHub or Git experience.

## 🔷 How to fix a misspelling on a 4Geeks Lesson:  

![edit on Github](https://github.com/breatheco-de/the-misspelling-challenge/blob/master/assets/github-logo2.png?raw=true)
